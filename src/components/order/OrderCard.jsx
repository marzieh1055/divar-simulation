...
function OrderCard({ id, post, proposed_price, order_state, message }) {
        ...
        <div class=" w-1/3 flex flex-col items-center p-6 bg-white border border-neutral-200 rounded-lg shadow ">
          ...
          <div className=" flex w-full gap-4 mt-4">
            <button
              ...
              class="text-center w-full items-center px-3 py-2 text-sm font-medium text-white bg-red-800 rounded-lg hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 "
            >
              بستن
            </button>
